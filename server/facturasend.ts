...
const FACTURASEND_CONFIG = {
  apiKey: process.env.FACTURASEND_API_KEY || 'DB0F6BD9-824E-4B93-A5E4-450B2B6E681F',
  baseUrl: 'https://api.facturasend.com.py/jhonifabianbenitezdelacruz',
  tenantId: 'jhonifabianbenitezdelacruz',
  ambiente: process.env.FACTURASEND_AMBIENTE || 'prod' // Cambiado a prod según notificación SET
};
